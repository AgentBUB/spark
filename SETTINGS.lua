...
---------------CONFIGURED VEHICLES-----------------
configured_vehicles = {'f150gw','arrowp','challengers'}
--  Spawn codes for all the vehicles that you have configured within the CONFIGS folder.
--  If the spawn code is not in this list, then the configuration won't actually work.
...
auto_park_pattern = true
--  Enable the park pattern automatically when vehicle enters "park"
parkPatternSync = true
--  Enable the syncing of park patterns with other vehicles around you
parkPatternSyncCooldown = 5
--  How long to wait between park pattern syncs (SECONDS)
parkPatternSyncDistance = 30
--  How far away should vehicles sync park patterns?
