...
RMenu.Add('spark', 'main', RageUI.CreateMenu(' ', Lang:t('menu.main'), 0, 0, "spark", "spark_logo"))
RMenu.Add('spark', 'maintone', RageUI.CreateSubMenu(RMenu:Get('spark', 'main'),' ', Lang:t('menu.siren'), 0, 0, "spark", "spark_logo"))
RMenu.Add('spark', 'hudsettings', RageUI.CreateSubMenu(RMenu:Get('spark', 'main'),' ', Lang:t('menu.hud'), 0, 0, "spark", "spark_logo"))
RMenu.Add('spark', 'audiosettings', RageUI.CreateSubMenu(RMenu:Get('spark', 'main'),' ', Lang:t('menu.audio'), 0, 0, "spark", "spark_logo"))
RMenu.Add('spark', 'volumesettings', RageUI.CreateSubMenu(RMenu:Get('spark', 'audiosettings'),' ', Lang:t('menu.audio'), 0, 0, "spark", "spark_logo"))
RMenu.Add('spark', 'plugins', RageUI.CreateSubMenu(RMenu:Get('spark', 'main'),' ', Lang:t('menu.plugins'), 0, 0, "spark", "spark_plugin_logo"))
RMenu.Add('spark', 'saveload', RageUI.CreateSubMenu(RMenu:Get('spark', 'main'),' ', Lang:t('menu.storage'), 0, 0, "spark", "spark_logo"))
RMenu.Add('spark', 'copyprofile', RageUI.CreateSubMenu(RMenu:Get('spark', 'saveload'),' ', Lang:t('menu.copy'), 0, 0, "spark", "spark_logo"))
RMenu.Add('spark', 'info', RageUI.CreateSubMenu(RMenu:Get('spark', 'main'),' ', Lang:t('menu.more_info'), 0, 0, "spark", "spark_logo"))
RMenu:Get('spark', 'main'):SetTotalItemsPerPage(13)
RMenu:Get('spark', 'volumesettings'):SetTotalItemsPerPage(12)
RMenu:Get('spark', 'main'):DisplayGlare(false)
RMenu:Get('spark', 'maintone'):DisplayGlare(false)
RMenu:Get('spark', 'hudsettings'):DisplayGlare(false)
RMenu:Get('spark', 'audiosettings'):DisplayGlare(false)
RMenu:Get('spark', 'volumesettings'):DisplayGlare(false)
RMenu:Get('spark', 'plugins'):DisplayGlare(false)
RMenu:Get('spark', 'saveload'):DisplayGlare(false)
RMenu:Get('spark', 'copyprofile'):DisplayGlare(false)
RMenu:Get('spark', 'info'):DisplayGlare(false)
...
Keys.Register(open_menu_key, 'spark', Lang:t('control.menu_desc'), function()
	if not key_lock and player_is_emerg_driver and UpdateOnscreenKeyboard() ~= 0 then
		...
		RageUI.Visible(RMenu:Get('spark', 'main'), not RageUI.Visible(RMenu:Get('spark', 'main')))
	end
end)

---------------------------------------------------------------------
-- Triggered when vehicle changes (cl_spark.lua)
RegisterNetEvent('spark:onVehicleChange')
AddEventHandler('spark:onVehicleChange', function()
...
function IsMenuOpen()
	return 	RageUI.Visible(RMenu:Get('spark', 'main')) or
			RageUI.Visible(RMenu:Get('spark', 'maintone')) or
			RageUI.Visible(RMenu:Get('spark', 'hudsettings')) or
			RageUI.Visible(RMenu:Get('spark', 'audiosettings')) or
			RageUI.Visible(RMenu:Get('spark', 'volumesettings')) or
			RageUI.Visible(RMenu:Get('spark', 'saveload')) or
			RageUI.Visible(RMenu:Get('spark', 'copyprofile')) or
			RageUI.Visible(RMenu:Get('spark', 'info')) or
			RageUI.Visible(RMenu:Get('spark', 'plugins')) or
			IsPluginMenuOpen()
end
...
CreateThread(function()
    while true do
		--Main Menu Visible
	    RageUI.IsVisible(RMenu:Get('spark', 'main'), function()
		...
		---------------------------------------------------------------------
		--HUD SETTINGS
	    RageUI.IsVisible(RMenu:Get('spark', 'hudsettings'), function()
		...
		--AUDIO SETTINGS MENU
		RageUI.IsVisible(RMenu:Get('spark', 'audiosettings'), function()
			...
			}, RMenu:Get('spark', 'volumesettings'))
        end)		
		--VOLUME SETTINGS MENU
		RageUI.IsVisible(RMenu:Get('spark', 'volumesettings'), function()
		...
		----------------------------SAVE LOAD MENU---------------------------
		---------------------------------------------------------------------
	    RageUI.IsVisible(RMenu:Get('spark', 'saveload'), function()
			...
			RageUI.Button(Lang:t('menu.copy'), Lang:t('menu.copy_desc'), {RightLabel = '→→→'}, #profiles > 0, {}, RMenu:Get('spark', 'copyprofile'))
			  ...
			  onSelected = function()
				if confirm_fr_msg == Lang:t('menu.confirm') then
					...
					if choice then
						...
						RageUI.Visible(RMenu:Get('spark', 'saveload'), true)
					end
					confirm_fr_msg = nil
				else
					RageUI.Settings.Controls.Back.Enabled = false
		...
		--Copy Profiles Menu
	    RageUI.IsVisible(RMenu:Get('spark', 'copyprofile'), function()
		...
		----------------------------MORE INFO MENU---------------------------
		---------------------------------------------------------------------
	    RageUI.IsVisible(RMenu:Get('spark', 'info'), function()
